...
<form action="suggest_action.php"  method=post>
<div class="usercontainer">
	<label style="font-size: 15px; color: #fff; opacity: 0.8">Register your suggestions here. We'll get back to you at the earliest.</label>
	<hr color="#000">
	<h4 id="head" >About</h4>
